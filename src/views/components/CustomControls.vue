    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6">
          ...
          <base-checkbox v-model="checkboxes.uncheckedDisabled" class="mb-3" disabled>
            Unchecked
          </base-checkbox>
          <base-checkbox v-model="checkboxes.checkedDisabled" class="mb-3" disabled>
            Checked
          </base-checkbox>
        </div>
        <div class="col-lg-3 col-sm-6 mt-4 mt-md-0">
          ...
          <base-radio v-model="radio.radio1" class="mb-3" name="radio0">
            Unchecked
          </base-radio>

          <base-radio v-model="radio.radio1" class="mb-3" name="radio1">
            Checked
          </base-radio>


          <base-radio v-model="radio.radio2" class="mb-3" disabled name="radio2">
            Disabled unchecked
          </base-radio>

          <base-radio v-model="radio.radio2" class="mb-3" disabled name="radio3">
            Disabled checked
          </base-radio>
        </div>
        <div class="col-lg-3 col-sm-6 mt-4 mt-md-0">
        ...
        <div class="col-lg-12">
          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <base-nav effect="dark" expand round title="Menu" type="primary">
                ...
                <ul class="navbar-nav ml-lg-auto">
                  ...
                  <li class="nav-item dropdown">
                    <a id="nav-inner-primary_dropdown_1" aria-expanded="false" aria-haspopup="true"
                       class="nav-link" data-toggle="dropdown" href="#"
                       role="button">Settings</a>
                    <div aria-labelledby="nav-inner-primary_dropdown_1"
            ...
            <div class="col-lg-6 mt-4 mt-lg-0">
              ...
              <base-nav effect="dark" expand round title="Menu" type="success">
                <div slot="content-header" slot-scope="{closeMenu}" class="row">
                  <div class="col-6 collapse-brand">
                    <a href="./index.html">
                      <img src="img/brand/blue.png">
                ...
                <ul class="navbar-nav ml-lg-auto">
                  ...
                  <li class="nav-item dropdown">
                    <a id="nav-inner-success_dropdown_1" aria-expanded="false"
                       aria-haspopup="true" class="nav-link nav-link-icon"
                       data-toggle="dropdown" href="#" role="button">
                      <i class="ni ni-settings-gear-65"></i>
                      <span class="nav-link-inner--text d-lg-none">Settings</span>
                    </a>
                    <div aria-labelledby="nav-inner-success_dropdown_1"
                         class="dropdown-menu dropdown-menu-right">
                      <a class="dropdown-item" href="#">Action</a>
                      <a class="dropdown-item" href="#">Another action</a>
                      <div class="dropdown-divider"></div>
