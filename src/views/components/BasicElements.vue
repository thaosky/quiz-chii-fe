      ...
      <div class="row justify-content-center">
        <div class="col-lg-12">
          ...
          <div>
            ...
            <base-button class="btn-3" icon="ni ni-bag-17" type="primary">Button</base-button>
            <base-button class="btn-2" icon="ni ni-bag-17" type="primary"></base-button>
          ...
          <a class="btn btn-link text-default" href="#">Default</a>
          <a class="btn btn-link text-primary" href="#">Primary</a>
          <a class="btn btn-link text-info" href="#">Info</a>
          <a class="btn btn-link text-success" href="#">Success</a>
          <a class="btn btn-link text-warning" href="#">Warning</a>
          <a class="btn btn-link text-danger" href="#">Danger</a>
        </div>
      </div>
    </div>
  </section>
